...
public class OrsOsmTrajectoryGeneratorModule extends AbstractTrajectoryGeneratorModule {

    public OrsOsmTrajectoryGeneratorModule(Config generatorParameters, ErrorHandler errorHandler) {
