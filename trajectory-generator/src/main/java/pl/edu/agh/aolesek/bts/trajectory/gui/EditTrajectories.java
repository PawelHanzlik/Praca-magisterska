 ...
 * @author godle
 */
public class EditTrajectories extends javax.swing.JFrame {

    /**
     * Creates new form EditTrajectories
     */
    
    String fileName;
    
    public EditTrajectories() {
        initComponents();
        this.setVisible(true);
        //jTextField44.setVisible(false); //użyte pole jako kino
        pack();
        fileName = "src/main/resources/average_spent_minutes_per_category.txt";
        setTitle("Edit stops");
    ...
    if(lines.size()<43)
        ...
        jTextField18.setText(lines.get(17));
        jTextField19.setText(lines.get(18));
        jTextField20.setText(lines.get(19));
        jTextField21.setText(lines.get(20));
        jTextField22.setText(lines.get(21));
        jTextField23.setText(lines.get(22));
        jTextField24.setText(lines.get(23));
        jTextField25.setText(lines.get(24));
        jTextField26.setText(lines.get(25));
        jTextField27.setText(lines.get(26));
        jTextField28.setText(lines.get(27));
        jTextField29.setText(lines.get(28));
        jTextField30.setText(lines.get(29));
        jTextField31.setText(lines.get(30));
        jTextField32.setText(lines.get(31));
        jTextField33.setText(lines.get(32));
        jTextField34.setText(lines.get(33));
        jTextField35.setText(lines.get(34));
        jTextField36.setText(lines.get(35));
        jTextField37.setText(lines.get(36));
        jTextField38.setText(lines.get(37));
        jTextField39.setText(lines.get(38));
        jTextField40.setText(lines.get(39));
        jTextField41.setText(lines.get(40));
        jTextField42.setText(lines.get(41));
        jTextField43.setText(lines.get(42));  
        jTextField44.setText(lines.get(43));     
    ...
    private void fillList(){
        ...
        lines.add(jTextField16.getText());
        lines.add(jTextField17.getText());
        lines.add(jTextField18.getText());
        lines.add(jTextField19.getText());
        lines.add(jTextField20.getText());
        lines.add(jTextField21.getText());
        lines.add(jTextField22.getText());  
        lines.add(jTextField23.getText());
        lines.add(jTextField24.getText());
        lines.add(jTextField25.getText());
        ...
        lines.add(jTextField36.getText());  
        lines.add(jTextField37.getText());  
        lines.add(jTextField38.getText());  
        lines.add(jTextField39.getText());  
        lines.add(jTextField40.getText());  
        lines.add(jTextField41.getText());  
        lines.add(jTextField42.getText());  
        lines.add(jTextField43.getText());  
        lines.add(jTextField44.getText());  
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Average time spent in object");

        jLabel2.setText("amusement_park");

        jLabel3.setText("aquarium");

        jLabel4.setText("art_gallery");

        jLabel5.setText("bar");

        jLabel6.setText("battlefield");

        jLabel7.setText("beach");

        jLabel8.setText("beauty_salon");

        jLabel9.setText("bowling_alley");

        jLabel10.setText("cafe");

        jLabel11.setText("casino");

        jLabel12.setText("castle");
        ...
        jLabel13.setText("cemetery");

        jLabel14.setText("church");

        jLabel15.setText("florist");

        jLabel16.setText("gambling");

        jLabel17.setText("gym");

        jLabel18.setText("hindu_temple");

        jLabel19.setText("jewelry_store");

        jLabel20.setText("library");

        jLabel21.setText("liquor_store");

        jLabel22.setText("marketplace");

        jLabel23.setText("memorial");
        ...
        jLabel24.setText("monastery");

        jLabel25.setText("mounment");

        jLabel26.setText("mosque");

        jLabel27.setText("movie_rental");

        jLabel28.setText("movie_theater");

        jLabel29.setText("museum");

        jLabel30.setText("night_club");

        jLabel31.setText("park");

        jLabel32.setText("pet_store");

        jLabel33.setText("place_of_worship");

        jLabel34.setText("planetarium");
        ...
        jLabel36.setText("ruins");

        jLabel37.setText("spa");

        jLabel38.setText("stadium");

        jLabel39.setText("store");

        jLabel40.setText("synagogue");

        jLabel41.setText("theme_park");

        jLabel42.setText("town_square");

        jLabel43.setText("viewpoint");

        jLabel44.setText("zoo");

        jLabel45.setText("cinema");
        ...
        jTextField44.setText("TextField44");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(jTextField24, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditTrajectories().setVisible(true);
            }
        });
    }*/
